/**
 * SafeTrace Backend Server
 * ------------------------
 * Express API backing the Anonymous Harassment Reporting & Investigation Platform.
 *
 * Storage: in-memory (Map + arrays) — chosen for hackathon-demo reliability and
 * zero external infra. Swappable for MongoDB later without touching route logic,
 * since all persistence goes through the `db` helper object below.
 *
